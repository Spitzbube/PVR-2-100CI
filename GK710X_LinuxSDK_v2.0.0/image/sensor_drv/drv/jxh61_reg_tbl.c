...
**
** \version     $Id: jxh61_reg_tbl.c 10611 2016-10-14 09:26:10Z yulindeng $
**
** \brief
**
...
#define JXH61_H_MIRROR  (1<<5)
    ...
    // hmax = (JXH61_FRAMEW_H & 0x3F) << 8 +
    //        (JXH61_FRAMEW_L & 0xFF) << 0
    .hmax_reg =
    {
        {0x21, 0x00, 0x3F, 0x00, 0x08, 0}, // JXH61_FRAMEW_H
        {0x20, 0x00, 0xFF, 0x00, 0x00, 0}, // JXH61_FRAMEW_L
        {GADI_VI_SENSOR_TABLE_FLAG_END,},
    },
    // vmax = (JXH61_FRAMEH_H & 0xFF) << 8 +
    //        (JXH61_FRAMEH_L & 0xFF) << 0
    .vmax_reg =
    {
        {0x23, 0x00, 0xFF, 0x00, 0x08, 0}, // JXH61_FRAMEH_H
        {0x22, 0x00, 0xFF, 0x00, 0x00, 0}, // JXH61_FRAMEH_L
        {GADI_VI_SENSOR_TABLE_FLAG_END,},
    },
    .vmax_wadd_reg = {GADI_VI_SENSOR_TABLE_FLAG_END,},
    // shs = (JXH61_EXP_H & 0xFF) << 8 +
    //       (JXH61_EXP_L & 0xFF) << 0
    .shs_reg =
    {
        {0x02, 0x00, 0xFF, 0x00, 0x08, 0}, // JXH61_EXP_H
        {0x01, 0x00, 0xFF, 0x00, 0x00, 0}, // JXH61_EXP_L
        {GADI_VI_SENSOR_TABLE_FLAG_END,},
    },
