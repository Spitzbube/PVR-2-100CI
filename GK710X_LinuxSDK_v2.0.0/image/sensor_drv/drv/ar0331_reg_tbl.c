/*!
*****************************************************************************
** \file        ar0331_reg_tbl.c
**
** \version     $Id: ar0331_reg_tbl.c 10611 2016-10-14 09:26:10Z yulindeng $
**
** \brief
**
...
*****************************************************************************
*/
GADI_VI_SensorDrvInfoT    ar0331_sensor =
{
    ...
    .field_format       = 1,
    .adapter_id         = 0,
    .sensor_id          = GADI_ISP_SENSOR_AR0331,
    ...
    .video_fmt_table =
    {
        [0] = //2304x1296@29.97p
        {
            ...
            .fmt_reg =
            {
                {0x3002, 0x0004},   //AR0230_Y_ADDR_START,
                {0x3004, 0x0006},   //AR0230_X_ADDR_START,
                {0x3006, 1539},   //AR0230_Y_ADDR_END,
                {0x3008, 2053},   //AR0230_X_ADDR_END,
                {0x300A, 1657},   //AR0230_FRAME_LENGTH_LINES,
                {0x300C, 1120},   //AR0230_LINE_LENGTH_PCK,
                {0x3012, 0x031B},   //AR0230_COARSE_INTEGRATION_TIME,
                {0x3014, 0x0000},   //AR0230_COARSE_INTEGRATION_TIME,
                {0x30A2, 0x0001},   //AR0230_X_ODD_INC,
                {0x30A6, 0x0001},   //AR0230_Y_ODD_INC,
                {0x3040, 0x0000},   //AR0230_READ_MODE,
                {0x31AE, 0x0304},   //AR0230_SERIAL_FORMAT,
                {GADI_VI_SENSOR_TABLE_FLAG_END,},
            },
            .vi_info =
            {
                ...
                .dgain_type = GADI_ISP_TUNNING_DATA_AE_SHT_DGAIN_MODE0,
            },
            .video_info_table =
            {
                .def_start_x        = 0,
        ...
        [1] = //1920x1080@30p
        {
            ...
            .fmt_reg =
            {
                {0x3002, 228},      //AR0230_Y_ADDR_START,
                {0x3004, 66},       //AR0230_X_ADDR_START,
                {0x3006, 1307},     //AR0230_Y_ADDR_END,
                {0x3008, 1993},     //AR0230_X_ADDR_END,
                {0x300A, 1125},     //AR0230_FRAME_LENGTH_LINES,
                {0x300C, 2200},     //AR0230_LINE_LENGTH_PCK,
                {0x3012, 0x0464},   //AR0230_COARSE_INTEGRATION_TIME,
                {0x3014, 0x0000},   //AR0230_COARSE_INTEGRATION_TIME,
                {0x30A2, 0x0001},   //AR0230_X_ODD_INC,
                {0x30A6, 0x0001},   //AR0230_Y_ODD_INC,
                {0x3040, 0x0000},   //AR0230_READ_MODE,
        ...
        [2] = //1280x720
        {
            ...
            .fmt_reg =
            {
                {0x3002, 408},      //AR0230_Y_ADDR_START,
                {0x3004, 386},      //AR0230_X_ADDR_START,
                {0x3006, 1135},     //AR0230_Y_ADDR_END,
                {0x3008, 1673},     //AR0230_X_ADDR_END,
                {0x300A, 757},      //AR0230_FRAME_LENGTH_LINES,
                {0x300C, 1634},     //AR0230_LINE_LENGTH_PCK,
                {0x3012, 0x02C6},   //AR0230_COARSE_INTEGRATION_TIME,
                {0x3014, 0x0000},   //AR0230_COARSE_INTEGRATION_TIME,
                {0x30A2, 0x0001},   //AR0230_X_ODD_INC,
                {0x30A6, 0x0001},   //AR0230_Y_ODD_INC,
                {0x3040, 0x0000},   //AR0230_READ_MODE,
            ...
            .vi_info =
            {
                ...
                .dgain_type = GADI_ISP_TUNNING_DATA_AE_SHT_DGAIN_MODE1,
            },
            .video_info_table =
            {
                .def_start_x        = 0,
    ...
    .mirror_table =
    {
#define AR0331_HORIZ_MIRROR     0x4000
#define AR0331_VERT_FLIP        0x8000
        [GADI_VI_SRC_MIRROR_HORRIZONTALLY_VERTICALLY] =
        {
            {0x3040, AR0331_HORIZ_MIRROR | AR0331_HORIZ_MIRROR, AR0331_HORIZ_MIRROR | AR0331_HORIZ_MIRROR},
            {GADI_VI_SENSOR_TABLE_FLAG_END,},
        },
        [GADI_VI_SRC_MIRROR_HORRIZONTALLY] =
        {
            {0x3040, AR0331_HORIZ_MIRROR, AR0331_HORIZ_MIRROR | AR0331_HORIZ_MIRROR},
            {GADI_VI_SENSOR_TABLE_FLAG_END,},
        },
        [GADI_VI_SRC_MIRROR_VERTICALLY] =
        {
            {0x3040, AR0331_VERT_FLIP, AR0331_HORIZ_MIRROR | AR0331_HORIZ_MIRROR},
            {GADI_VI_SENSOR_TABLE_FLAG_END,},
        },
        [GADI_VI_SRC_MIRROR_NONE] =
        {
            {0x3040, 0x00, AR0331_HORIZ_MIRROR | AR0331_HORIZ_MIRROR},
            {GADI_VI_SENSOR_TABLE_FLAG_END,},
        },
    },
    .version_reg =
    ...
    .hmax_reg =
    {
        {0x300C, 0x0000, 0xFFFF, 0x00, 0x00, 0}, // AR0331_LINE_LENGTH_PCK
        {GADI_VI_SENSOR_TABLE_FLAG_END,},
    },
    .vmax_reg =
    {
        {0x300A, 0x0000, 0xFFFF, 0x00, 0x00, 0}, // AR0331_FRAME_LENGTH_LINES
        {GADI_VI_SENSOR_TABLE_FLAG_END,},
    },
    .vmax_wadd_reg = {GADI_VI_SENSOR_TABLE_FLAG_END,},
    .shs_reg =
    {
        {0x3012, 0x0000, 0xFFFF, 0x00, 0x00, 0}, // AR0331_COARSE_INTEGRATION_TIME
        {GADI_VI_SENSOR_TABLE_FLAG_END,},
    },
    ...
    .gain_reg =
    {
        {0x3060, 0x00}, // AR0331_GAIN_COL_REG_AGAIN
        {0x305E, 0x00}, // AR0331_GAIN_COL_REG_DGAIN
        {GADI_VI_SENSOR_TABLE_FLAG_END,},
    },
    .gain_table =
    {
        ...
        {0x000C0000 * 0x0331, {0x0030 , 0x0530},},        /*index: 80, 38.3813dB */
        ...
        {0x000C0000 * 0x02D6, {0x0030 , 0x0331},},        /*index: 170, 34.1481dB */
