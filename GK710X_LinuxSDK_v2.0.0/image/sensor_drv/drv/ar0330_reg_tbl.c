...
**
** \version     $Id: ar0330_reg_tbl.c 10611 2016-10-14 09:26:10Z yulindeng $
**
** \brief
**
    ...
    .video_fmt_table =
    {
        [0] = //2304x1296@29.97p
        {
            ...
            .fmt_reg =
            {
                ...
                {0x300A, 0x051C}, // FRAME_LENGTH_LINE
        ...
        [1] = //1920x1080@30p
        {
            ...
            .fmt_reg =
            {
                ...
                {0x3006, 0x051B}, // Y_ADDR_END
                {0x30A2, 0x0001}, // X_ODD_INCREMENT
                {0x30A6, 0x0001}, // Y_ODD_INCREMENT
                {0x300C, 0x05CC}, // LINE_LENGTH_PCK
                {0x300A, 0x044E}, // FRAME_LENGTH_LINE
                {0x3014, 0x0000}, // FINE_INTEGRATION_TIME
        ...
        [2] = //2048x1536@25p
        {
            ...
            .fmt_reg =
            {
                {0x3004, 0x0080}, // X_ADDR_START
                {0x3008, 0x087F}, // X_ADDR_END
                {0x3002, 0x0000}, // Y_ADDR_START
                {0x3006, 0x05FF}, // Y_ADDR_END
                {0x30A2, 0x0001}, // X_ODD_INCREMENT
                {0x30A6, 0x0001}, // Y_ODD_INCREMENT
                {0x300C, 0x04A0}, // LINE_LENGTH_PCK
                {0x300A, 0x060C}, // FRAME_LENGTH_LINE
                {0x3014, 0x0000}, // FINE_INTEGRATION_TIME
                {0x3012, 0x060B}, // Coarse_Integration_Time
                {0x3042, 0x0000}, // EXTRA_DELAY
                {0x3040, 0x0000}, // Row Bin
                {0x30BA, 0x002C}, // digital_ctrl
                {0x301A, 0x10DA}, // start_streaming
...
#define AR0330_VERT_FLIP        0x8000
        ...
        {
            {0x3040, AR0330_HORIZ_MIRROR | AR0330_HORIZ_MIRROR, AR0330_HORIZ_MIRROR | AR0330_HORIZ_MIRROR},
            {GADI_VI_SENSOR_TABLE_FLAG_END,},
        },
        [GADI_VI_SRC_MIRROR_HORRIZONTALLY] =
        {
            {0x3040, AR0330_HORIZ_MIRROR, AR0330_HORIZ_MIRROR | AR0330_HORIZ_MIRROR},
            {GADI_VI_SENSOR_TABLE_FLAG_END,},
        },
        [GADI_VI_SRC_MIRROR_VERTICALLY] =
        {
            {0x3040, AR0330_VERT_FLIP, AR0330_HORIZ_MIRROR | AR0330_HORIZ_MIRROR},
            {GADI_VI_SENSOR_TABLE_FLAG_END,},
        },
        [GADI_VI_SRC_MIRROR_NONE] =
        {
            {0x3040, 0x00, AR0330_HORIZ_MIRROR | AR0330_HORIZ_MIRROR},
            {GADI_VI_SENSOR_TABLE_FLAG_END,},
        },
    },
    .version_reg =
    ...
    .hmax_reg =
    {
        {0x300C, 0x0000, 0xFFFF, 0x00, 0x00, 0}, // AR0330_LINE_LENGTH_PCK
        {GADI_VI_SENSOR_TABLE_FLAG_END,},
    },
    .vmax_reg =
    {
        {0x300A, 0x0000, 0xFFFF, 0x00, 0x00, 0}, // AR0330_FRAME_LENGTH_LINES
        {GADI_VI_SENSOR_TABLE_FLAG_END,},
    },
    .vmax_wadd_reg = {GADI_VI_SENSOR_TABLE_FLAG_END,},
    .shs_reg =
    {
        {0x3012, 0x0000, 0xFFFF, 0x00, 0x00, 0}, // AR0330_COARSE_INTEGRATION_TIME
        {GADI_VI_SENSOR_TABLE_FLAG_END,},
    },
