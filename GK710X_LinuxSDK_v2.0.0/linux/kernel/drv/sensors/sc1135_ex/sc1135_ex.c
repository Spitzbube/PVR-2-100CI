...
#ifdef SET_REG_BY_VSYNC
static int sc1135_adc_ch = 0;
static int sc1135_reg_3630 = 0;
static int sc1135_reg_3631 = 0;
static int sc1135_reg_3e08 = 0;
static int sc1135_reg_3e09 = 0;
//static int sc1135_reg_3e0f = 0;


static int sc1135_last_reg_3630 = 0xffffffff;
static int sc1135_last_reg_3631 = 0xffffffff;
static int sc1135_last_reg_3e08 = 0xffffffff;
static int sc1135_last_reg_3e09 = 0xffffffff;
//static int sc1135_last_reg_3e0f = 0xffffffff;

#ifdef SET_SHUTTER_BY_VSYNC

static int sc1135_shutter_ch = 0;
static int sc1135_reg_exp_time_h = 0;
static int sc1135_reg_exp_time_l = 0;
static int sc1135_reg_331e = 0;

static int sc1135_last_reg_exp_time_h = 0xffffffff;
static int sc1135_last_reg_exp_time_l = 0xffffffff;
static int sc1135_last_reg_331e =0xffffffff;
...
//*****************************************************************************
//*****************************************************************************
static int sc1135_set_agc_db(int handle, s32 agc_db)
{
    int                     errorCode = 0;
...
#ifdef SET_REG_BY_VSYNC
    sc1135_reg_3630 = idc_reg0;
    sc1135_reg_3631 = idc_reg1;
    sc1135_reg_3e08 = idc_reg2;
    sc1135_reg_3e09 = idc_reg3;
    sc1135_adc_ch = 1;
#else
...
static int sc1135_set_shutter_time(int handle, u32 shutter_time, u32 extclk, u32 pclk)
{
    int     errorCode = 0;
...
#ifdef SET_REG_BY_VSYNC
#ifdef SET_SHUTTER_BY_VSYNC
    sc1135_reg_exp_time_h = shr_width_m;
    sc1135_reg_exp_time_l =  ((shr_width_l << 4) & 0xf0);
#else
...
#ifdef SET_REG_BY_VSYNC
#ifdef SET_SHUTTER_BY_VSYNC
    sc1135_reg_331e = sc1135_331e_value;
    sc1135_shutter_ch = 1;
#else
...
static int sc1135_set_fps(int handle, u32 fps, u32 extclk, u32 pclk)
{
    int                             errorCode           = 0;
    u64                             frame_time_pclk;
    u32                             line_length         = 0;
...
static int sc1135_set_update_reg(int handle)
{
...
#ifdef SET_REG_BY_VSYNC
#ifdef SET_SHUTTER_BY_VSYNC
    if(sc1135_shutter_ch == 1)
    {
        if(sc1135_last_reg_exp_time_h!=sc1135_reg_exp_time_h)
        {
            sensor_write_reg_ex(handle, SC1135_AEC_EXP_TIME_H, sc1135_reg_exp_time_h,0);
        }
        if(sc1135_last_reg_exp_time_l!=sc1135_reg_exp_time_l)
        {
            sensor_write_reg_ex(handle, SC1135_AEC_EXP_TIME_L, sc1135_reg_exp_time_l,0);
        }
        if(sc1135_last_reg_331e!=sc1135_reg_331e)
        {
            sensor_write_reg_ex(handle, SC1135_331E, sc1135_reg_331e,0);//
        }

        sc1135_last_reg_exp_time_h = sc1135_reg_exp_time_h;
        sc1135_last_reg_exp_time_l = sc1135_reg_exp_time_l;
        sc1135_last_reg_331e =sc1135_reg_331e;
        sc1135_shutter_ch = 0;
        shutter_chnged = 1;
    }
#endif
    if(sc1135_adc_ch == 1)
    {
        if(agc_offset!=0)
        {
            sc1135_reg_3e09=sc1135_get_again_from_offset(sc1135_reg_3e09, agc_offset);
        }
        if(sc1135_last_reg_3e09!=sc1135_reg_3e09)
        {
            if(shutter_chnged==0)
            {
            }
            sensor_write_reg_ex(handle, SC1135_AEC_AGAIN, sc1135_reg_3e09,0);
        }
        if(sc1135_last_reg_3e08!=sc1135_reg_3e08)
        {
#if 0
...
#endif
            sensor_write_reg_ex(handle, SC1135_AEC_DGAIN, sc1135_reg_3e08,0);  //0401 hhl note: what is 0x3E0A ?
        }
        //0401 hhl add
        /*****************0401 hhl add (head)******************/
        if (sc1135_last_reg_3630 != sc1135_reg_3630)
        {
            sensor_write_reg_ex(handle, SC1135_3630, sc1135_reg_3630,0);
        }
        if (sc1135_last_reg_3631 != sc1135_reg_3631)
        {
            sensor_write_reg_ex(handle, SC1135_3631, sc1135_reg_3631,0);
        }
        /*****************0401 hhl add (end)******************/
        sc1135_adc_ch = 0;
        sc1135_last_reg_3630=sc1135_reg_3630;
        sc1135_last_reg_3631=sc1135_reg_3631;
        sc1135_last_reg_3e08=sc1135_reg_3e08;
        sc1135_last_reg_3e09=sc1135_reg_3e09;
    }
    ...
    {
        agc_offset++;
        sc1135_last_reg_3e09=sc1135_get_again_from_offset(sc1135_last_reg_3e09,1);
        sensor_write_reg_ex(handle, SC1135_AEC_AGAIN, sc1135_last_reg_3e09,0);
    }
...
{
    sc1135.sensor_set_shutter_time  = sc1135_set_shutter_time;
    sc1135.sensor_set_fps           = sc1135_set_fps;
    sc1135.sensor_set_agc_db        = sc1135_set_agc_db;
    sc1135.sensor_set_update_reg    = sc1135_set_update_reg;
    sensor_registry_api(&sc1135);
    return 0;
}

static void __exit sc1135_exit(void)
{
    sensor_unregistry_api();
}
