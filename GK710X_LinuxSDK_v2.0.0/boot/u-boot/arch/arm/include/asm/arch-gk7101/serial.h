...
#ifndef _SERIAL_GK7101_H_
#define _SERIAL_GK7101_H_
...
#define     GK7101_APB_FREQ     48000000
#define     UART_BASE_FREQ     (GK7101_APB_FREQ / 2)    //unit:Hz 27MHz
...
#define GK7101_PA_UART0         (REG_UART0_BASE)
#define UART0_PA_ADDR           (GK7101_PA_UART0)
...
#define UART0_REG(x)            (GK7101_PA_UART0 + (x))
