...
#if defined(CONFIG_MACH_GK7101S_RB_OV2710_V1_00)
#define SYSTEM_GPIO_EXTPHY_TABLE                     \
    { GPIO_7 , GPIO_TYPE_OUTPUT_1 /*ETH reset*/   }, \
    { GPIO_9 , GPIO_TYPE_OUTPUT_ENET_PHY_TXEN     }, \
    { GPIO_10, GPIO_TYPE_OUTPUT_ENET_PHY_TXD_1    }, \
    { GPIO_11, GPIO_TYPE_OUTPUT_ENET_PHY_TXD_0    }, \
    { GPIO_12, SYSTEM_GPIO_PHY_CLK      /*GPIO_TYPE_INPUT_ENET_PHY_RXD_2 CLK*/}, \
    { GPIO_14, GPIO_TYPE_INPUT_ENET_PHY_RXD_1     }, \
    { GPIO_15, GPIO_TYPE_INPUT_ENET_PHY_RXD_0     }, \
    { GPIO_18, GPIO_TYPE_INPUT                    }, \
    { GPIO_21, GPIO_TYPE_INPUT_ENET_PHY_RXER      }, \
    { GPIO_23, GPIO_TYPE_INPUT_ENET_PHY_RXDV      }, \
    { GPIO_50, GPIO_TYPE_INPUT                    },

#define SYSTEM_GPIO_INTPHY_TABLE                     \
    { GPIO_7 , GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_9 , GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_10, GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_11, GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_12, GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_14, GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_15, GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_18, GPIO_TYPE_OUTPUT_EPHY_LED_3        }, \
    { GPIO_21, GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_23, GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_50, SYSTEM_GPIO_PHY_CLK                },

#define SYSTEM_GPIO_XREF_TABLE                       \
    { GPIO_0 , GPIO_TYPE_OUTPUT_SF_CS0            }, \
    { GPIO_1 , GPIO_TYPE_OUTPUT_SF_CS1            }, \
    { GPIO_2 , GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_3 , GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_4 , GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_5 , GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_6 , GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_8 , GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_13, GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_16, GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_17, GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_19, GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_20, GPIO_TYPE_INPUT_UART0_RX           }, \
    { GPIO_22, GPIO_TYPE_OUTPUT_UART0_TX          }, \
    { GPIO_24, GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_25, GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_26, GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_27, GPIO_TYPE_OUTPUT_1 /*Sensor reset*/}, \
    { GPIO_28, GPIO_TYPE_INOUT_I2C_DATA /*S D*/   }, \
    { GPIO_29, GPIO_TYPE_INOUT_I2C_CLK  /*S C*/   }, \
    { GPIO_30, GPIO_TYPE_INPUT      /* ALARM_IN */}, \
    { GPIO_31, GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_32, GPIO_TYPE_INPUT     /* ALARM_OUT */}, \
    { GPIO_33, GPIO_TYPE_OUTPUT_0  /*IR_LED_CTRL*/}, \
    { GPIO_34, GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_35, GPIO_TYPE_OUTPUT_0      /*IR_CUT+*/}, \
    { GPIO_36, GPIO_TYPE_OUTPUT_0      /*IR_CUT-*/}, \
    { GPIO_37, GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_38, GPIO_TYPE_INPUT      /*IR_DET_ADC*/}, \
    { GPIO_39, GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_40, GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_41, GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_42, GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_43, GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_44, GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_45, GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_46, GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_47, GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_48, GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_49, GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_51, GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_52, GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_53, GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_54, GPIO_TYPE_OUTPUT_0                    }, \
    { GPIO_55, GPIO_TYPE_OUTPUT_0                    }, \
...
#define SYSTEM_GPIO_IR_LED_CTRL     GPIO_33
#define SYSTEM_GPIO_IR_CUT1         GPIO_35
#define SYSTEM_GPIO_IR_CUT2         GPIO_36
#define SYSTEM_GPIO_SENSOR_RESET    GPIO_27
#define SYSTEM_GPIO_PHY_RESET       GPIO_7
#define SYSTEM_GPIO_PHY_SPEED_LED   GPIO_18

#define SYSTEM_GPIO_SPI0_EN0        GPIO_45 // not real pin
#define SYSTEM_GPIO_SPI1_EN0        GPIO_46 // not real pin
#define SYSTEM_GPIO_PWM0            GPIO_47 // not real pin
#define SYSTEM_GPIO_PWM1            GPIO_48 // not real pin
#define SYSTEM_GPIO_PWM2            GPIO_49 // not real pin
#define SYSTEM_GPIO_PWM3            GPIO_51 // not real pin
#define SYSTEM_GPIO_USB_HOST        GPIO_52 // not real pin
#define SYSTEM_GPIO_SD_DETECT       GPIO_53 // not real pin
#define SYSTEM_GPIO_SD_POWER        GPIO_55 // not real pin
#endif /* CONFIG_MACH_GK7101S_RB_OV2710_V1_00 */

#if defined(CONFIG_MACH_GK7101S_RB_OV2710_V2_00)
#define SYSTEM_GPIO_EXTPHY_TABLE                     \
    { GPIO_7 , GPIO_TYPE_OUTPUT_1 /*ETH reset*/   }, \
    { GPIO_9 , SYSTEM_GPIO_PHY_CLK                }, \
    { GPIO_10, GPIO_TYPE_OUTPUT_ENET_PHY_TXEN     }, \
    { GPIO_11, GPIO_TYPE_OUTPUT_ENET_PHY_TXD_1    }, \
    { GPIO_12, GPIO_TYPE_OUTPUT_ENET_PHY_TXD_0    }, \
    { GPIO_14, GPIO_TYPE_INPUT_ENET_PHY_RXD_2/*CLK*/}, \
    { GPIO_15, GPIO_TYPE_INPUT_ENET_PHY_RXD_1     }, \
    { GPIO_18, GPIO_TYPE_INPUT                    }, \
    { GPIO_20, GPIO_TYPE_INPUT_ENET_PHY_RXD_0     }, \
    { GPIO_21, GPIO_TYPE_INPUT_ENET_PHY_RXER      }, \
    { GPIO_22, GPIO_TYPE_INPUT_ENET_PHY_RXDV      }, \
    { GPIO_25, GPIO_TYPE_INOUT_ETH_MDIO           }, \
...
#define SYSTEM_GPIO_INTPHY_TABLE                     \
    ...
    { GPIO_12, GPIO_TYPE_INPUT                    }, \
    { GPIO_14, GPIO_TYPE_INPUT                    }, \
    { GPIO_15, GPIO_TYPE_INPUT                    }, \
    { GPIO_18, GPIO_TYPE_OUTPUT_EPHY_LED_3        }, \
    { GPIO_20, GPIO_TYPE_INPUT                    }, \
    { GPIO_21, GPIO_TYPE_INPUT                    }, \
    { GPIO_22, GPIO_TYPE_INPUT                    }, \
    { GPIO_25, GPIO_TYPE_INPUT                    }, \
    { GPIO_26, GPIO_TYPE_INPUT                    }, \
    { GPIO_50, SYSTEM_GPIO_PHY_CLK                },
...
#define SYSTEM_GPIO_XREF_TABLE                       \
    ...
    { GPIO_38, GPIO_TYPE_INPUT      /*IR_DET_ADC*/}, \
    { GPIO_39, GPIO_TYPE_INPUT                    }, \
    { GPIO_40, GPIO_TYPE_INPUT                    }, \
    { GPIO_41, GPIO_TYPE_INPUT_UART0_RX           }, \
    { GPIO_42, GPIO_TYPE_INPUT                    }, \
    { GPIO_43, GPIO_TYPE_INPUT                    }, \
    { GPIO_44, GPIO_TYPE_OUTPUT_UART0_TX          }, \
    { GPIO_45, GPIO_TYPE_INPUT                    }, \
    { GPIO_46, GPIO_TYPE_INPUT                    }, \
...
#define SYSTEM_GPIO_SD_DETECT       GPIO_53 // not real pin
#define SYSTEM_GPIO_SD_POWER        GPIO_55 // not real pin
#endif /* CONFIG_MACH_GK7101S_RB_OV2710_V2_00 */

#if defined(CONFIG_MACH_GK7101S_RB_OV2710_V2_10)
#define SYSTEM_GPIO_EXTPHY_TABLE                          \
...
#define SYSTEM_GPIO_XREF_TABLE                            \
    ...
    { GPIO_27, GPIO_TYPE_INPUT                         }, \
    { GPIO_28, GPIO_TYPE_INPUT                         }, \
    { GPIO_29, GPIO_TYPE_INPUT                         }, \
    { GPIO_34, GPIO_TYPE_INPUT                         }, \
    { GPIO_37, GPIO_TYPE_INOUT_I2C_DATA         /*S D*/}, \
    { GPIO_38, GPIO_TYPE_INOUT_I2C_CLK          /*S C*/}, \
    { GPIO_39, GPIO_TYPE_INPUT_SD_CD_N                 }, \
    { GPIO_40, GPIO_TYPE_OUTPUT_1      /*Sensor reset*/}, \
...
#define SYSTEM_GPIO_SENSOR_RESET    GPIO_40
...
#endif /* CONFIG_MACH_GK7101S_RB_OV2710_V2_10 */

#if defined(CONFIG_MACH_GK7101S_RB_OV2710_V2_20)
#define SYSTEM_GPIO_EXTPHY_TABLE                          \
    { GPIO_3 , GPIO_TYPE_INPUT_ENET_PHY_RXDV           }, \
    { GPIO_30, GPIO_TYPE_OUTPUT_ENET_PHY_TXEN          }, \
    { GPIO_31, GPIO_TYPE_OUTPUT_ENET_PHY_TXD_1         }, \
...
#define SYSTEM_GPIO_SD_DETECT       GPIO_39
#define SYSTEM_GPIO_SD_POWER        GPIO_46
#endif /* CONFIG_MACH_GK7101S_RB_OV2710_V2_20 */
