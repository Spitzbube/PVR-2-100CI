...
#if defined(CONFIG_MACH_GK7101S_RB_V1_00)
...
#define SYSTEM_GPIO_SD_TABLE                              \
    ...
    { GPIO_41, GPIO_TYPE_OUTPUT_1            /*USB_PD*/}, \
...
#define SYSTEM_GPIO_XREF_TABLE                            \
    ...
    { GPIO_20, GPIO_TYPE_OUTPUT_UART0_TX               }, \
    { GPIO_21, GPIO_TYPE_OUTPUT_UART2_DTR_N/*RS485_RE*/}, \
    { GPIO_22, GPIO_TYPE_INPUT_UART0_RX                }, \
...
#define SYSTEM_GPIO_PWM0            GPIO_12 // SYSTEM_GPIO_IR_LED_CTRL
#define SYSTEM_GPIO_PWM1            GPIO_10 // SYSTEM_GPIO_IR_CUT1
#define SYSTEM_GPIO_PWM2            GPIO_9  // SYSTEM_GPIO_IR_CUT2
#define SYSTEM_GPIO_PWM3            GPIO_55 // not real pin
#define SYSTEM_GPIO_USB_HOST        GPIO_55 // not real pin
#define SYSTEM_GPIO_SD_DETECT       GPIO_50
#define SYSTEM_GPIO_SD_POWER        GPIO_55 // not real pin
#endif

#if defined(CONFIG_MACH_GK7101S_RB_V1_10)
#define SYSTEM_GPIO_EXTPHY_TABLE                          \
    { GPIO_5 , GPIO_TYPE_INPUT_ENET_PHY_RXER           }, \
    { GPIO_6 , GPIO_TYPE_OUTPUT_ENET_GMII_MDC_O        }, \
    { GPIO_8 , GPIO_TYPE_OUTPUT_ENET_PHY_TXEN          }, \
    { GPIO_9 , GPIO_TYPE_OUTPUT_ENET_PHY_TXD_1         }, \
    { GPIO_10, GPIO_TYPE_OUTPUT_ENET_PHY_TXD_0         }, \
    { GPIO_11, SYSTEM_GPIO_PHY_CLK                     }, \
    { GPIO_12, GPIO_TYPE_INPUT_ENET_PHY_RXD_0          }, \
    { GPIO_14, GPIO_TYPE_INPUT_ENET_PHY_RXD_1          }, \
    { GPIO_15, GPIO_TYPE_INPUT_ENET_PHY_RXDV           }, \
    { GPIO_17, GPIO_TYPE_INPUT                         }, \
    { GPIO_18, GPIO_TYPE_INPUT_ENET_PHY_RXD_2   /*CLK*/}, \
    { GPIO_31, GPIO_TYPE_INPUT                         },
...
#define SYSTEM_GPIO_INTPHY_TABLE                          \
    ...
    { GPIO_17, GPIO_TYPE_OUTPUT_EPHY_LED_3             }, \
...
#define SYSTEM_GPIO_XREF_TABLE                            \
    { GPIO_0 , GPIO_TYPE_OUTPUT_SF_CS0                 }, \
    { GPIO_1 , GPIO_TYPE_INPUT                         }, \
    { GPIO_2 , GPIO_TYPE_INPUT                         }, \
    { GPIO_3 , GPIO_TYPE_INOUT_ETH_MDIO                }, \
    ...
    { GPIO_23, GPIO_TYPE_INPUT_SPI0_SI                 }, \
    { GPIO_24, GPIO_TYPE_OUTPUT_SPI0_SO                }, \
    { GPIO_25, GPIO_TYPE_OUTPUT_SPI0_CS0               }, \
    { GPIO_26, GPIO_TYPE_OUTPUT_SPI0_SCLK              }, \
    { GPIO_27, GPIO_TYPE_INPUT                         }, \
    { GPIO_28, GPIO_TYPE_INPUT                         }, \
    { GPIO_29, GPIO_TYPE_INPUT                         }, \
    { GPIO_30, GPIO_TYPE_INPUT          /* ALARM_OUT */}, \
    { GPIO_32, GPIO_TYPE_INPUT           /* ALARM_IN */}, \
    { GPIO_33, GPIO_TYPE_INPUT                         }, \
    { GPIO_34, GPIO_TYPE_INPUT                         }, \
    { GPIO_35, GPIO_TYPE_INPUT                         }, \
    { GPIO_36, GPIO_TYPE_INPUT                         }, \
    { GPIO_37, GPIO_TYPE_INOUT_I2C_CLK       /*S C*/   }, \
    { GPIO_38, GPIO_TYPE_INOUT_I2C_DATA      /*S D*/   }, \
    { GPIO_39, GPIO_TYPE_OUTPUT_AO_DATA0               }, \
    { GPIO_40, GPIO_TYPE_INPUT                         }, \
    { GPIO_41, GPIO_TYPE_OUTPUT_1      /*Sensor reset*/}, \
    { GPIO_42, GPIO_TYPE_INPUT                         }, \
    { GPIO_43, GPIO_TYPE_OUTPUT_PWM0_OUT               }, \
    { GPIO_44, GPIO_TYPE_INPUT_I2S_SI                  }, \
    { GPIO_45, GPIO_TYPE_INPUT                         }, \
    { GPIO_46, GPIO_TYPE_INPUT                         }, \
    { GPIO_47, GPIO_TYPE_OUTPUT_PWM1_OUT               }, \
...
#define SYSTEM_GPIO_IR_LED_CTRL     GPIO_50 // not real pin
#define SYSTEM_GPIO_IR_CUT1         GPIO_48 // not real pin
#define SYSTEM_GPIO_IR_CUT2         GPIO_49 // not real pin
#define SYSTEM_GPIO_SENSOR_RESET    GPIO_41
#define SYSTEM_GPIO_PHY_RESET       GPIO_51 // not real pin
#define SYSTEM_GPIO_PHY_SPEED_LED   GPIO_17

#define SYSTEM_GPIO_SPI0_EN0        GPIO_25
#define SYSTEM_GPIO_SPI1_EN0        GPIO_46 // not real pin
#define SYSTEM_GPIO_PWM0            GPIO_43
#define SYSTEM_GPIO_PWM1            GPIO_47
