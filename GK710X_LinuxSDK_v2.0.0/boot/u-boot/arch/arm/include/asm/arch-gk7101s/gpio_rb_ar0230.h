#ifndef _GPIO_RB_AR0230_H_
#define _GPIO_RB_AR0230_H_
...
#define SYSTEM_GPIO_XREF_TABLE                            \
    ...
    { GPIO_25, GPIO_TYPE_INOUT_I2C_DATA2               }, \
    { GPIO_26, GPIO_TYPE_INOUT_I2C_CLK2                }, \
    ...
    { GPIO_37, GPIO_TYPE_INPUT_SD_CD_N                 }, \
    { GPIO_38, GPIO_TYPE_INOUT_SD_DATA_2               }, \
    { GPIO_39, GPIO_TYPE_INOUT_SD_DATA_1               }, \
    { GPIO_40, GPIO_TYPE_INOUT_SD_DATA_3               }, \
    { GPIO_42, GPIO_TYPE_INOUT_SD_CMD                  }, \
    { GPIO_45, GPIO_TYPE_INOUT_SD_DATA_0               }, \
    { GPIO_53, GPIO_TYPE_OUTPUT_1/*SDIO_CARD_POWER_EN*/}, \
    { GPIO_54, GPIO_TYPE_OUTPUT_SDIO_CLK               }, \
...
#define SYSTEM_GPIO_SPI0_EN0        GPIO_4  // not real pin
#define SYSTEM_GPIO_SPI1_EN0        GPIO_5  // not real pin
#define SYSTEM_GPIO_PWM0            GPIO_6  // not real pin
#define SYSTEM_GPIO_PWM1            GPIO_7  // not real pin
#define SYSTEM_GPIO_PWM2            GPIO_8  // not real pin
#define SYSTEM_GPIO_PWM3            GPIO_9  // not real pin
#define SYSTEM_GPIO_USB_HOST        GPIO_10 // not real pin
#define SYSTEM_GPIO_SD_DETECT       GPIO_37
#define SYSTEM_GPIO_SD_POWER        GPIO_53
#endif /* CONFIG_MACH_GK7101S_RB_AR0230_V1_00 */

#endif /* _GPIO_RB_AR0230_H_ */
