...
#define AX_DEFAULT_RX_CTL	\
	(AX_RX_CTL_SO | AX_RX_CTL_AB|AX_RX_CTL_PRO)  //AX_RX_CTL_PRO for receive all packate, if no this flag, we only receive broadcast packate, it isn't receive unicast packate.
