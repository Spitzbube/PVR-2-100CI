...
{
    U32 value = (*(volatile U32 *)(REG_VIC_IRQSTS + index * FIO_MOFFSET(VIC,0x0000D000)));
...
{
    U32 value = (*(volatile U32 *)(REG_VIC_FIQSTS + index * FIO_MOFFSET(VIC,0x0000D000)));
...
{
    U32 value = (*(volatile U32 *)(REG_VIC_RAWSTS + index * FIO_MOFFSET(VIC,0x0000D000)));
...
{
    *(volatile U32 *)(REG_VIC_SELECT + index * FIO_MOFFSET(VIC,0x0000D000)) = data;
    #if GH_VIC_ENABLE_DEBUG_PRINT
    GH_VIC_DEBUG_PRINT_FUNCTION( "WRREG(0x%08x,0x%08x); \\\\ [GH_VIC_set_Select] <-- 0x%08x\n",
                        (REG_VIC_SELECT + index * FIO_MOFFSET(VIC,0x0000D000)),data,data);
    #endif
}
GH_INLINE U32  GH_VIC_get_Select(U8 index)
{
    U32 value = (*(volatile U32 *)(REG_VIC_SELECT + index * FIO_MOFFSET(VIC,0x0000D000)));
...
{
    *(volatile U32 *)(REG_VIC_ENABLE + index * FIO_MOFFSET(VIC,0x0000D000)) = data;
    #if GH_VIC_ENABLE_DEBUG_PRINT
    GH_VIC_DEBUG_PRINT_FUNCTION( "WRREG(0x%08x,0x%08x); \\\\ [GH_VIC_set_Enable] <-- 0x%08x\n",
                        (REG_VIC_ENABLE + index * FIO_MOFFSET(VIC,0x0000D000)),data,data);
    #endif
}
GH_INLINE U32  GH_VIC_get_Enable(U8 index)
{
    U32 value = (*(volatile U32 *)(REG_VIC_ENABLE + index * FIO_MOFFSET(VIC,0x0000D000)));
...
GH_INLINE void GH_VIC_set_EnClr(U8 index, U32 data)
{
    ...
    *(volatile U32 *)(REG_VIC_ENCLR + index * FIO_MOFFSET(VIC,0x0000D000)) = data;
    #if GH_VIC_ENABLE_DEBUG_PRINT
...
{
    *(volatile U32 *)(REG_VIC_SOFTINT + index * FIO_MOFFSET(VIC,0x0000D000)) = data;
    #if GH_VIC_ENABLE_DEBUG_PRINT
    GH_VIC_DEBUG_PRINT_FUNCTION( "WRREG(0x%08x,0x%08x); \\\\ [GH_VIC_set_SoftInt] <-- 0x%08x\n",
                        (REG_VIC_SOFTINT + index * FIO_MOFFSET(VIC,0x0000D000)),data,data);
    #endif
}
GH_INLINE U32  GH_VIC_get_SoftInt(U8 index)
{
    U32 value = (*(volatile U32 *)(REG_VIC_SOFTINT + index * FIO_MOFFSET(VIC,0x0000D000)));
...
GH_INLINE void GH_VIC_set_SoftIntrClr(U8 index, U32 data)
{
    ...
    *(volatile U32 *)(REG_VIC_SOFTINTRCLR + index * FIO_MOFFSET(VIC,0x0000D000)) = data;
    #if GH_VIC_ENABLE_DEBUG_PRINT
...
{
    *(volatile U32 *)(REG_VIC_PROTECT + index * FIO_MOFFSET(VIC,0x0000D000)) = data;
    #if GH_VIC_ENABLE_DEBUG_PRINT
    GH_VIC_DEBUG_PRINT_FUNCTION( "WRREG(0x%08x,0x%08x); \\\\ [GH_VIC_set_Protect] <-- 0x%08x\n",
                        (REG_VIC_PROTECT + index * FIO_MOFFSET(VIC,0x0000D000)),data,data);
    #endif
}
GH_INLINE U32  GH_VIC_get_Protect(U8 index)
{
    U32 value = (*(volatile U32 *)(REG_VIC_PROTECT + index * FIO_MOFFSET(VIC,0x0000D000)));
...
{
    GH_VIC_PROTECT_S d;
    d.all = *(volatile U32 *)(REG_VIC_PROTECT + index * FIO_MOFFSET(VIC,0x0000D000));
    d.bitc.protect = data;
    *(volatile U32 *)(REG_VIC_PROTECT + index * FIO_MOFFSET(VIC,0x0000D000)) = d.all;
    #if GH_VIC_ENABLE_DEBUG_PRINT
...
{
    *(volatile U32 *)(REG_VIC_SENSE + index * FIO_MOFFSET(VIC,0x0000D000)) = data;
    #if GH_VIC_ENABLE_DEBUG_PRINT
    GH_VIC_DEBUG_PRINT_FUNCTION( "WRREG(0x%08x,0x%08x); \\\\ [GH_VIC_set_Sense] <-- 0x%08x\n",
                        (REG_VIC_SENSE + index * FIO_MOFFSET(VIC,0x0000D000)),data,data);
    #endif
}
GH_INLINE U32  GH_VIC_get_Sense(U8 index)
{
    U32 value = (*(volatile U32 *)(REG_VIC_SENSE + index * FIO_MOFFSET(VIC,0x0000D000)));
...
{
    *(volatile U32 *)(REG_VIC_BOTHEDGE + index * FIO_MOFFSET(VIC,0x0000D000)) = data;
    #if GH_VIC_ENABLE_DEBUG_PRINT
    GH_VIC_DEBUG_PRINT_FUNCTION( "WRREG(0x%08x,0x%08x); \\\\ [GH_VIC_set_BothEdge] <-- 0x%08x\n",
                        (REG_VIC_BOTHEDGE + index * FIO_MOFFSET(VIC,0x0000D000)),data,data);
    #endif
}
GH_INLINE U32  GH_VIC_get_BothEdge(U8 index)
{
    U32 value = (*(volatile U32 *)(REG_VIC_BOTHEDGE + index * FIO_MOFFSET(VIC,0x0000D000)));
...
{
    *(volatile U32 *)(REG_VIC_EVENT + index * FIO_MOFFSET(VIC,0x0000D000)) = data;
    #if GH_VIC_ENABLE_DEBUG_PRINT
    GH_VIC_DEBUG_PRINT_FUNCTION( "WRREG(0x%08x,0x%08x); \\\\ [GH_VIC_set_Event] <-- 0x%08x\n",
                        (REG_VIC_EVENT + index * FIO_MOFFSET(VIC,0x0000D000)),data,data);
    #endif
}
GH_INLINE U32  GH_VIC_get_Event(U8 index)
{
    U32 value = (*(volatile U32 *)(REG_VIC_EVENT + index * FIO_MOFFSET(VIC,0x0000D000)));
...
GH_INLINE void GH_VIC_set_EdgeClr(U8 index, U32 data)
{
    ...
    *(volatile U32 *)(REG_VIC_EDGECLR + index * FIO_MOFFSET(VIC,0x0000D000)) = data;
    #if GH_VIC_ENABLE_DEBUG_PRINT
