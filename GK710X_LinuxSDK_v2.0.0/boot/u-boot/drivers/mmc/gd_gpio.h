...
typedef enum
{
    ...
    //GD_GPIO_TYPE_INOUT_SD_DATA_0                                                                                                                                         GD_GPIO_OEN_SEL( 9)                          GD_GPIO_OUT_SEL(23)
    //GD_GPIO_TYPE_INOUT_SD_DATA_0                                                                                                                                         GD_GPIO_OEN_SEL(10)                          GD_GPIO_OUT_SEL(24)
    //GD_GPIO_TYPE_INOUT_SD_DATA_0                                                                                                                                         GD_GPIO_OEN_SEL(11)                          GD_GPIO_OUT_SEL(25)
    //GD_GPIO_TYPE_INOUT_SD_DATA_0                                                                                                                                         GD_GPIO_OEN_SEL(12)                          GD_GPIO_OUT_SEL(26)
    //GD_GPIO_TYPE_INOUT_SD_DATA_0                                                                                                                                         GD_GPIO_OEN_SEL(13)                          GD_GPIO_OUT_SEL(27)
    //GD_GPIO_TYPE_INOUT_SD_DATA_0                                                                                                                                         GD_GPIO_OEN_SEL(14)                          GD_GPIO_OUT_SEL(28)
    //GD_GPIO_TYPE_INOUT_SD_DATA_0                                                                                                                                         GD_GPIO_OEN_SEL(15)                          GD_GPIO_OUT_SEL(29)
    ...
    GD_GPIO_TYPE_INPUT_1                = GD_GPIO_FUNC(GD_GPIO_FUNC_IN) | GD_GPIO_IOCTRL(IOCTRL_PULL_DOWN|IOCTRL_2MA)    | GD_GPIO_OEN_INVERT(0) | GD_GPIO_OUT_INVERT(0) | GD_GPIO_OEN_SEL( 1) | GD_GPIO_IN_SEL(   1) | GD_GPIO_OUT_SEL( 0),    //!< Input type: normal input
...
GERR GD_GPIO_DisableInterrupt(GD_HANDLE handle);
GERR GD_GPIO_EnableInterrupt(GD_HANDLE handle);
