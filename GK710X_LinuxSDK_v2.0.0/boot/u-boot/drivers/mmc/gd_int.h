...
**            access the GK710X/GK710XS interrupt engine.
**
...
enum
{
    ...
    GD_INT_CODING_ORC_VOUT1_IRQ =  1,  //!< edge, Coding Orc VOUT1
    GD_INT_CODING_ORC_VIN_IRQ   =  2,  //!< edge, Coding Orc VIN
    GD_INT_CORDING_ORC_VDSP_IRQ =  3,  //!< edge, Cording Orc vDSP
    GD_INT_USB_IRQ              =  4,  //!< level, USB
    GD_INT_UART2_IRQ            =  5,  //!< level, UART2
    GD_INT_XIU_TIMEOUT_IRQ      =  6,  //!< edge
    GD_INT_AUDIO_I2S_TX_IRQ     =  7,  //!< level, Audio (I2S) TX
    GD_INT_AUDIO_I2S_RX_IRQ     =  18,  //!< level, Audio (I2S) RX
    GD_INT_UART_IRQ             =  9,  //!< level, UART0
    GD_INT_GPIO0_IRQ            = 10,  //!< level, GPIO0
    GD_INT_RESERVED1_11_IRQ     = 11,  //!<
    GD_INT_TIMER1_IRQ           = 12,  //!< edge, timer#1
    GD_INT_TIMER2_IRQ           = 13,  //!< edge, timer#2
    GD_INT_SD_CARD_DETECT_IRQ   = 14,  //!< edge, timer#3
    GD_INT_DMA_IRQ              = 15,  //!< level, DMA
    GD_INT_RESERVED1_16_IRQ     = 16,  //!<
    GD_INT_RESERVED1_17_IRQ     = 17,  //!<
    GD_INT_SD_CONTROLLER_IRQ    =  8,  //!< level, SD controller
    GD_INT_IDC_IRQ              = 19,  //!< level, i2c read/write, I2C0
    GD_INT_SSI_SPI_IRQ          = 20,  //!< level, Synchronous Serial Interface (SSI, SPI)
    GD_INT_WDT_IRQ              = 21,  //!< edge, Watchdog (WDT)
    GD_INT_IRIF_IRQ             = 22,  //!< level, InfraRED interface (IRIF)
    //GD_INT_RESERVED1_22_IRQ     = 22,  //!<
    GD_INT_RESERVED1_23_IRQ     = 23,  //!<
    GD_INT_TIMER3_IRQ           = 24,  //!< Both edges, SD card detect (state of SMIO5 pin)
    GD_INT_UART1_IRQ            = 25,  //!< level, uart read/write, UART1
    GD_INT_SSI_SLAVE_IRQ        = 26,  //!< level, SSI Slave Interrupt
    GD_INT_ETH_IRQ              = 27,  //!< level, Ethernet 1
    GD_INT_IDSP_ERROR_IRQ       = 28,  //!< edge, iDSP error
    GD_INT_RESERVED1_29_IRQ     = 29,  //!<
    GD_INT_RESERVED1_30_IRQ     = 30,  //!<
    GD_INT_RESERVED1_31_IRQ     = 31,  //!<
#if (GD_VIC_INSTANCES >= 2)
    GD_INT_RESERVED2_00_IRQ     = ( 0 + 32),  //!<
    GD_INT_RESERVED2_01_IRQ     = ( 1 + 32),  //!<
    GD_INT_ADC_LEVEL_CHANGE_IRQ = ( 2 + 32),  //!< level, ADC level change
    GD_INT_RESERVED2_03_IRQ     = ( 3 + 32),  //!<
    GD_INT_IDC2_IRQ             = ( 4 + 32),  //!< level, IDC2
    GD_INT_IDSP_LAST_PIXEL_IRQ  = ( 5 + 32),  //!< edge, iDSP last pixel
    GD_INT_IDSP_VSYNC_IRQ       = ( 6 + 32),  //!< edge, iDSP Vsync (VIN on master mode)
    GD_INT_IDSP_SENSOR_VSYNC_IRQ= ( 7 + 32),  //!< edge, iDSP sensor Vsync (VIN on slave mode)
    GD_INT_PMU_IRQ              = ( 8 + 32),  //!< level, PMU
    GD_INT_SSI2_IRQ             = ( 9 + 32),  //!< level, SSI2
    GD_INT_RESERVED2_10_IRQ     = (10 + 32),  //!<
    GD_INT_RESERVED2_11_IRQ     = (11 + 32),  //!<
    GD_INT_CODING_ORC_VOUT0_IRQ = (12 + 32),  //!< edge, Coding Orc VOUT0
    ...
    GD_INT_GDMA_COMPLETION_IRQ  = (16 + 32),  //!< edge, GDMA Completion
    GD_INT_MOTOR_INTERRUPT_IRQ  = (17 + 32),  //!< level, Motor Interrupt
    GD_INT_AUDIO_PHY_RX_IRQ     = (18 + 32),  //!< level, Audio PHY RX INT
    GD_INT_AUDIO_PHY_TX_IRQ     = (19 + 32),  //!< level, Audio PHY TX INT
#endif
};
...
void GD_INT_SetVector(S8 vector, void (*target)(void));
