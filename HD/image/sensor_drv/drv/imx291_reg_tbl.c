...
**
** \version     $Id: imx291_reg_tbl.c 10611 2016-10-14 09:26:10Z yulindeng $
**
** \brief
**
...
#define IMX291_V_FLIP       (1<<0)
    ...
    // hmax = (IMX291_HMAX_MSB & 0xFF) << 8 +
    //        (IMX291_HMAX_LSB & 0xFF) << 0
    .hmax_reg =
    {
        {0x301D, 0x00, 0xFF, 0x00, 0x08, 0}, // IMX291_HMAX_MSB
        {0x301C, 0x00, 0xFF, 0x00, 0x00, 0}, // IMX291_HMAX_LSB
        {GADI_VI_SENSOR_TABLE_FLAG_END,},
    },
    // vmax = (IMX291_VMAX_MSB & 0xFF) << 8 +
    //        (IMX291_VMAX_LSB & 0xFF) << 0
    .vmax_reg =
    {
        {0x301A, 0x00, 0x03, 0x00, 0x10, 0}, // IMX291_VMAX_MSB
        {0x3019, 0x00, 0xFF, 0x00, 0x08, 0}, // IMX291_VMAX_MSB
        {0x3018, 0x00, 0xFF, 0x00, 0x00, 0}, // IMX291_VMAX_LSB
        {GADI_VI_SENSOR_TABLE_FLAG_END,},
    },
    ...
    .shs_reg =
    {
        ...
        {0x3021, 0x00, 0xFF, 0x00, 0x08, 0}, // INTEG_TIME_L
