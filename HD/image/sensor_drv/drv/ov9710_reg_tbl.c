...
**
** \version     $Id: ov9710_reg_tbl.c 10611 2016-10-14 09:26:10Z yulindeng $
**
** \brief
**
...
#define OV9710_VERT_FLIP        (0x01 << 6)
    ...
    // hmax = (OV9710_TIMING_CONTROL_HTS_HIGHBYTE & 0xFF) << 8 +
    //        (OV9710_TIMING_CONTROL_HTS_LOWBYTE & 0xFF) << 0
    .hmax_reg =
    {
    ...
    // vmax = (OV9710_TIMING_CONTROL_VTS_HIGHBYTE & 0xFF) << 8 +
    //        (OV9710_TIMING_CONTROL_VTS_LOWBYTE & 0xFF) << 0
    .vmax_reg =
    {
        {0x3E, 0x00, 0xFF, 0x00, 0x08, 0},
        {0x3D, 0x00, 0xFF, 0x00, 0x00, 0},
        {GADI_VI_SENSOR_TABLE_FLAG_END,},
    },
    .vmax_wadd_reg = {GADI_VI_SENSOR_TABLE_FLAG_END,},
    // shs = (OV9710_AEC_PK_EXPO_H & 0x0F) << 12 +
    //       (OV9710_AEC_PK_EXPO_M & 0xFF) << 4 +
    //       (OV9710_AEC_PK_EXPO_L & 0xF0) >> 4
    .shs_reg =
    {
        {0x16, 0x00, 0xFF, 0x00, 0x08, 0}, // AECH
        {0x10, 0x00, 0xFF, 0x00, 0x00, 0}, //AEC
        {GADI_VI_SENSOR_TABLE_FLAG_END,},
    },
