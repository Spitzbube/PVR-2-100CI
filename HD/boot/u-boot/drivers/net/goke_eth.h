...
#define ETH_DMA_MISS_OFCNT_OFFSET   0x1018
...
#define ETH_REG(x)                  (REG_ETH_MAC_CONFIG + (x))

#define ETH_MAC_CFG_REG             ETH_REG(ETH_MAC_CFG_OFFSET)
#define ETH_MAC_FRAME_FILTER_REG    ETH_REG(ETH_MAC_FRAME_FILTER_OFFSET)
#define ETH_MAC_HASH_HI_REG         ETH_REG(ETH_MAC_HASH_HI_OFFSET)
#define ETH_MAC_HASH_LO_REG         ETH_REG(ETH_MAC_HASH_LO_OFFSET)
#define ETH_MAC_GMII_ADDR_REG       ETH_REG(ETH_MAC_GMII_ADDR_OFFSET)
#define ETH_MAC_GMII_DATA_REG       ETH_REG(ETH_MAC_GMII_DATA_OFFSET)
#define ETH_MAC_FLOW_CTR_REG        ETH_REG(ETH_MAC_FLOW_CTR_OFFSET)
#define ETH_MAC_VLAN_TAG_REG        ETH_REG(ETH_MAC_VLAN_TAG_OFFSET)
#define ETH_MAC_VERSION_REG         ETH_REG(ETH_MAC_VERSION_OFFSET)
#define ETH_MAC_MAC0_HI_REG         ETH_REG(ETH_MAC_MAC0_HI_OFFSET)
#define ETH_MAC_MAC0_LO_REG         ETH_REG(ETH_MAC_MAC0_LO_OFFSET)
#define ETH_MAC_MAC1_HI_REG         ETH_REG(ETH_MAC_MAC1_HI_OFFSET)
#define ETH_MAC_MAC1_LO_REG         ETH_REG(ETH_MAC_MAC1_LO_OFFSET)
#define ETH_MAC_MAC2_HI_REG         ETH_REG(ETH_MAC_MAC2_HI_OFFSET)
#define ETH_MAC_MAC2_LO_REG         ETH_REG(ETH_MAC_MAC2_LO_OFFSET)

#define ETH_DMA_BUS_MODE_REG        ETH_REG(ETH_DMA_BUS_MODE_OFFSET)
#define ETH_DMA_TX_POLL_DMD_REG     ETH_REG(ETH_DMA_TX_POLL_DMD_OFFSET)
#define ETH_DMA_RX_POLL_DMD_REG     ETH_REG(ETH_DMA_RX_POLL_DMD_OFFSET)
#define ETH_DMA_RX_DESC_LIST_REG    ETH_REG(ETH_DMA_RX_DESC_LIST_OFFSET)
#define ETH_DMA_TX_DESC_LIST_REG    ETH_REG(ETH_DMA_TX_DESC_LIST_OFFSET)
#define ETH_DMA_STATUS_REG          ETH_REG(ETH_DMA_STATUS_OFFSET)
#define ETH_DMA_OPMODE_REG          ETH_REG(ETH_DMA_OPMODE_OFFSET)
#define ETH_DMA_INTEN_REG           ETH_REG(ETH_DMA_INTEN_OFFSET)
#define ETH_DMA_MISS_FRAME_BOCNT_REG ETH_REG(ETH_DMA_MISS_OFCNT_OFFSET)
#define ETH_DMA_HOST_TX_DESC_REG    ETH_REG(ETH_DMA_HOST_TX_DESC_OFFSET)
#define ETH_DMA_HOST_RX_DESC_REG    ETH_REG(ETH_DMA_HOST_RX_DESC_OFFSET)
#define ETH_DMA_HOST_TX_BUF_REG     ETH_REG(ETH_DMA_HOST_TX_BUF_OFFSET)
#define ETH_DMA_HOST_RX_BUF_REG     ETH_REG(ETH_DMA_HOST_RX_BUF_OFFSET)
