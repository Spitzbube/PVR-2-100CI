...
{
    U32 value = gk_irq_readl((REG_VIC_IRQSTS + index * FIO_MOFFSET(VIC,0x00001000)));
...
{
    U32 value = gk_irq_readl((REG_VIC_FIQSTS + index * FIO_MOFFSET(VIC,0x00001000)));
...
{
    U32 value = gk_irq_readl((REG_VIC_RAWSTS + index * FIO_MOFFSET(VIC,0x00001000)));
...
{
    gk_irq_writel(REG_VIC_SELECT + index * FIO_MOFFSET(VIC,0x00001000),data);
    #if GH_VIC_ENABLE_DEBUG_PRINT
...
{
    U32 value = gk_irq_readl((REG_VIC_SELECT + index * FIO_MOFFSET(VIC,0x00001000)));
...
{
    gk_irq_writel(REG_VIC_ENABLE + index * FIO_MOFFSET(VIC,0x00001000),data);
    #if GH_VIC_ENABLE_DEBUG_PRINT
...
{
    U32 value = gk_irq_readl((REG_VIC_ENABLE + index * FIO_MOFFSET(VIC,0x00001000)));
...
void GH_VIC_set_EnClr(U8 index, U32 data)
{
    ...
    gk_irq_writel(REG_VIC_ENCLR + index * FIO_MOFFSET(VIC,0x00001000),data);
    #if GH_VIC_ENABLE_DEBUG_PRINT
...
{
    gk_irq_writel(REG_VIC_SOFTINT + index * FIO_MOFFSET(VIC,0x00001000),data);
    #if GH_VIC_ENABLE_DEBUG_PRINT
...
{
    U32 value = gk_irq_readl((REG_VIC_SOFTINT + index * FIO_MOFFSET(VIC,0x00001000)));
...
void GH_VIC_set_SoftIntrClr(U8 index, U32 data)
{
    ...
    gk_irq_writel(REG_VIC_SOFTINTRCLR + index * FIO_MOFFSET(VIC,0x00001000),data);
    #if GH_VIC_ENABLE_DEBUG_PRINT
...
{
    gk_irq_writel(REG_VIC_PROTECT + index * FIO_MOFFSET(VIC,0x00001000),data);
    #if GH_VIC_ENABLE_DEBUG_PRINT
...
{
    U32 value = gk_irq_readl((REG_VIC_PROTECT + index * FIO_MOFFSET(VIC,0x00001000)));
...
{
    GH_VIC_PROTECT_S d;
    d.all = gk_irq_readl(REG_VIC_PROTECT + index * FIO_MOFFSET(VIC,0x00001000));
    d.bitc.protect = data;
    gk_irq_writel(REG_VIC_PROTECT + index * FIO_MOFFSET(VIC,0x00001000),d.all);
    #if GH_VIC_ENABLE_DEBUG_PRINT
...
{
    gk_irq_writel(REG_VIC_SENSE + index * FIO_MOFFSET(VIC,0x00001000),data);
    #if GH_VIC_ENABLE_DEBUG_PRINT
...
{
    U32 value = gk_irq_readl((REG_VIC_SENSE + index * FIO_MOFFSET(VIC,0x00001000)));
...
{
    gk_irq_writel(REG_VIC_BOTHEDGE + index * FIO_MOFFSET(VIC,0x00001000),data);
    #if GH_VIC_ENABLE_DEBUG_PRINT
...
{
    U32 value = gk_irq_readl((REG_VIC_BOTHEDGE + index * FIO_MOFFSET(VIC,0x00001000)));
...
{
    gk_irq_writel(REG_VIC_EVENT + index * FIO_MOFFSET(VIC,0x00001000),data);
    #if GH_VIC_ENABLE_DEBUG_PRINT
...
{
    U32 value = gk_irq_readl((REG_VIC_EVENT + index * FIO_MOFFSET(VIC,0x00001000)));
...
void GH_VIC_set_EdgeClr(U8 index, U32 data)
{
    ...
    gk_irq_writel(REG_VIC_EDGECLR + index * FIO_MOFFSET(VIC,0x00001000),data);
    #if GH_VIC_ENABLE_DEBUG_PRINT
