...
#if defined(CONFIG_MACH_GK7101S_RB_JXH42_V1_00) || \
    defined(CONFIG_MACH_GK7102S_RB_JXH42_V1_00)
#define SYSTEM_GPIO_EXTPHY_TABLE                          \
    { GPIO_2 , GPIO_TYPE_INPUT_ENET_PHY_RXER           }, \
    { GPIO_3 , GPIO_TYPE_OUTPUT_ENET_GMII_MDC_O        }, \
    { GPIO_32, GPIO_TYPE_INPUT_ENET_PHY_RXD_1          }, \
    { GPIO_33, GPIO_TYPE_INOUT_ETH_MDIO                }, \
    { GPIO_41, GPIO_TYPE_OUTPUT_1         /*ETH reset*/}, \
    { GPIO_43, SYSTEM_GPIO_PHY_CLK                     }, \
    { GPIO_44, GPIO_TYPE_OUTPUT_ENET_PHY_TXEN          }, \
    { GPIO_46, GPIO_TYPE_OUTPUT_ENET_PHY_TXD_1         }, \
    { GPIO_47, GPIO_TYPE_OUTPUT_ENET_PHY_TXD_0         }, \
    { GPIO_48, GPIO_TYPE_INPUT                         }, \
    { GPIO_49, GPIO_TYPE_INPUT                         }, \
    { GPIO_50, GPIO_TYPE_INPUT_ENET_PHY_RXD_2   /*CLK*/}, \
    { GPIO_51, GPIO_TYPE_INPUT_ENET_PHY_RXDV           }, \
    { GPIO_52, GPIO_TYPE_INPUT_ENET_PHY_RXD_0          },
...
#define SYSTEM_GPIO_INTPHY_TABLE                          \
    ...
    { GPIO_49, GPIO_TYPE_OUTPUT_EPHY_LED_3             }, \
...
#define SYSTEM_GPIO_XREF_TABLE                            \
    ...
    { GPIO_30, GPIO_TYPE_OUTPUT_UART0_TX               }, \
    { GPIO_31, GPIO_TYPE_INPUT_UART0_RX                }, \
    { GPIO_34, GPIO_TYPE_INPUT                         }, \
    { GPIO_35, GPIO_TYPE_INOUT_I2C_DATA2               }, \
    { GPIO_36, GPIO_TYPE_INOUT_I2C_CLK2                }, \
    ...
    { GPIO_53, GPIO_TYPE_INPUT          /* ALARM_OUT */}, \
    { GPIO_54, GPIO_TYPE_INPUT           /* ALARM_IN */}, \
...
#define SYSTEM_GPIO_PHY_RESET       GPIO_41
#define SYSTEM_GPIO_PHY_SPEED_LED   GPIO_49

#define SYSTEM_GPIO_SPI0_EN0        GPIO_37 // not real pin
#define SYSTEM_GPIO_SPI1_EN0        GPIO_38 // not real pin
#define SYSTEM_GPIO_PWM0            GPIO_39 // not real pin
#define SYSTEM_GPIO_PWM1            GPIO_40 // not real pin
#define SYSTEM_GPIO_PWM2            GPIO_42 // not real pin
#define SYSTEM_GPIO_PWM3            GPIO_45 // not real pin
#define SYSTEM_GPIO_USB_HOST        GPIO_55 // not real pin
#define SYSTEM_GPIO_SD_DETECT       GPIO_4  // not real pin
#define SYSTEM_GPIO_SD_POWER        GPIO_5  // not real pin
#endif /* CONFIG_MACH_GK7102S_RB_JXH42_V1_00 */

#if defined(CONFIG_MACH_GK7101S_RB_JXH42_V2_00) || \
    defined(CONFIG_MACH_GK7102S_RB_JXH42_V2_00)
#define SYSTEM_GPIO_EXTPHY_TABLE                          \
...
#endif /* CONFIG_MACH_GK7102S_RB_JXH42_V2_00 */


#if defined(CONFIG_MACH_GK7101S_RB_JXH42_V2_10) || \
    defined(CONFIG_MACH_GK7102S_RB_JXH42_V2_10)
#define SYSTEM_GPIO_EXTPHY_TABLE                          \
    { GPIO_3 , GPIO_TYPE_INPUT_ENET_PHY_RXDV           }, \
    { GPIO_30, GPIO_TYPE_OUTPUT_ENET_PHY_TXEN          }, \
    { GPIO_31, GPIO_TYPE_OUTPUT_ENET_PHY_TXD_1         }, \
...
#define SYSTEM_GPIO_SD_DETECT       GPIO_39
#define SYSTEM_GPIO_SD_POWER        GPIO_46
#endif /* CONFIG_MACH_GK7102S_RB_JXH42_V2_10 */
