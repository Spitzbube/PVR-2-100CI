...
extern GERR GD_INT_Init(GD_INT_INIT_PARAMS_S *initParams);
extern void GD_INT_EnableAllInterrupts(void);
extern void GD_INT_DisableAllInterrupts(void);
