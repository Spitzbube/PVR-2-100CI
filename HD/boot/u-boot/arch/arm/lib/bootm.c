...
static void boot_prep_linux(bootm_headers_t *images)
{
	...
	if(getenv("ramdiskaddr")&&getenv("ramdiskend")){
		images->rd_start = simple_strtoul(getenv("ramdiskaddr"), NULL, 16);
		images->rd_end = simple_strtoul(getenv("ramdiskend"), NULL, 16);
...
static void boot_jump_linux(bootm_headers_t *images)
{
	...
	printf("machid = %d r2 = 0x%x \n", (unsigned long)machid, r2);
	ARM1176_set_and_go(0, machid, r2, (unsigned long)kernel_entry);
