...
//*****************************************************************************
//*****************************************************************************
#define MAX_CAP_FRAEM_SIZE 720*576
...
static const char *shortOptions = "hSPI:OCEc:ltb:i:v:o:";
...
static GADI_S32 pda_capture_bmp(void)
{
    ...
    if(gadi_pda_capture_buffer(&video_frame_info) != GADI_OK)
    {
...
static void pda_cap_yuv_12(void)
{
    ...
    if(gadi_pda_capture_buffer(&info) != GADI_OK)
    {
        GADI_ERROR("pda_capture_bmp: failed\n");
    ...
    GADI_INFO("gadi_pda_capture_buffer ok\n");
    sprintf((char*)fileName,"/opt/pda_%d_%d_yv12.yuv",info.width,info.height);
...
static void Usage(void)
{
    ...
    printf("\t-h, --help            help.\n"
           ...
           "\t-o <number>, --osd    use display pda data(disable:0 enable:1),\n"
           "        need open OSD.");
    ...
    while ((ch = getopt_long(argc, argv, shortOptions, longOptions, &option_index)) != -1)
    {
        ...
        case 'c':
            if (atoi(optarg) == 0){
                ...
                GADI_ERROR("no params; save pictrue format(bmp:0 yuv:1)\n");
            }
            break;
        ////////////////////////////////////////////////////////////////////////
        ////////////////////////////////////////////////////////////////////////
