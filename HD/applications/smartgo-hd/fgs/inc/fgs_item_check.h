...
*****************************************************************************
**
** \file        ./applications/smartgo-hd/fgs/inc/fgs_item_check.h
**
...
*****************************************************************************
*/
#ifndef _FGS_ITEM_CHECK_H_
#define _FGS_ITEM_CHECK_H_
...
} FGS_ITEM_CHECK_INIT_S;

typedef struct
{
    fbool_t                   active;      //!< default activity state
    
} FGS_ITEM_CHECK_PARAMS_S;
...
typedef struct
{
    ...
    FGS_ITEM_CHECK_PARAMS_S params;
    
} FGS_ITEM_CHECK_OPEN_S;

typedef struct
{
    FGS_ITEM_CHECK_OPEN_S data;
    FGS_LIST_MEMBER_S*    pMem;          //!< pointer to own member structure
    
} FGS_ITEM_CHECK_INST_S;
