...
*****************************************************************************
**
** \file        ./applications/smartgo-hd/fgs/inc/fgs_item_select.h
**
...
*****************************************************************************
*/
#ifndef _FGS_ITEM_SELECT_H_
#define _FGS_ITEM_SELECT_H_
...
typedef struct
{
    uint32_t                numItems;         //!< number of available sub-indexes
    uint32_t                index;            //!< initial list index
    
} FGS_ITEM_SEL_PARAMS_S;
...
typedef struct
{
    ...
    FGS_POS_S             valuePos; /*28*/     //!< value position in item area
    
    FGS_ITEM_SEL_PARAMS_S params; //40
    
} FGS_ITEM_SEL_OPEN_S;

typedef struct
{
    FGS_ITEM_SEL_OPEN_S  data;
