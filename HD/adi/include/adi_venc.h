...
typedef struct
{
    ...
    GADI_U32            vbrMaxbps;
    /*picture quality consistency ,range: 0~3. 2:will be best.*/
    GADI_U8             adaptQp;
    /*qpMinI&qpMinP example (picure quality from poor to good)
            qpMinI: 23,     qpMinP:26      // poor
            qpMinI: 20,     qpMinP:23
            qpMinI: 18,     qpMinP:22
            qpMinI: 14,     qpMinP:17       //good
        */
...
typedef struct
{
    ...
    /*gop N value.*/
    GADI_U8             gopN;
}GADI_VENC_H264GopNConfigT;

typedef struct
{
    /*stream index.*/
    GADI_U32            streamId;
    GADI_S8             i_16x16_cost;      // -64~64, clamp the negative value to -64 to avoid underflow
    GADI_S8             i_4x4_cost;        // -64~64, clamp the negative value to -64 to avoid underflow
    GADI_S8             p_16x16_cost;      // -64~64, clamp the negative value to -64 to avoid underflow
    GADI_S8             p_8x8_cost;        // -64~64, clamp the negative value to -64 to avoid underflow
    GADI_S8             skip_chance;
    GADI_S8             dbf_alpha;              // between -6 and 6
    GADI_S8             dbf_beta;               // between -6 and 6
...
typedef struct
{
    ...
    GADI_U16            i_pskip_chance;
}GADI_VENC_EncConfigT;
...
** - #GADI_OK
**
** \sa gadi_venc_get_h264_gopn
**
*******************************************************************************
*/
GADI_ERR gadi_venc_get_h264_gopn(GADI_SYS_HandleT handle,
        GADI_VENC_H264GopNConfigT* configPar);
...
** - #GADI_OK
**
** \sa gadi_venc_set_h264_gopn
**
*******************************************************************************
*/

GADI_ERR gadi_venc_set_h264_gopn(GADI_SYS_HandleT handle,
        GADI_VENC_H264GopNConfigT* configPar);
...
*******************************************************************************
*/
GADI_ERR gadi_venc_get_h264_enc(GADI_SYS_HandleT handle,
        GADI_VENC_EncConfigT * configPar);
...
*******************************************************************************
*/
GADI_ERR gadi_venc_set_h264_enc(GADI_SYS_HandleT handle,
        GADI_VENC_EncConfigT * configPar);
